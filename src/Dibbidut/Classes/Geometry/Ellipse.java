...
public class Ellipse extends Geometry {
    ...
    public Ellipse(Vector center, double semiMajorAxis, double semiMinorAxis) {
        ...
        minorAxisReferencePoint = new Vector(center.getX(), center.getY() + semiMinorAxis);
        majorAxisReferencePoint = new Vector(center.getX() + semiMajorAxis, center.getY());
    }

    @Override
    public void transform(Transformation transformation) {
        // Create ellipse data with center (0,0)
        Vector originEllipseCenter = new Vector(0, 0);
        Vector originEllipseMinAxisRefPoint = new Vector(0, semiMinorAxis);
        Vector originEllipseMajAxisRefPoint = new Vector(semiMajorAxis, 0);
        ...
        center = originEllipseCenter.addVector(centerDisplacement);
